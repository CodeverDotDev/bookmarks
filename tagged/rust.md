...
---
#### [mvdnes/zip-rs](https://github.com/mvdnes/zip-rs)
_<sup>https://github.com/mvdnes/zip-rs</sup>_

read and write ZIP archives [![Build Status](https://api.travis-ci.org/mvdnes/zip-rs.svg?branch=master)](https://travis-ci.org/mvdnes/zip-rs)
* **tags**: [rust](../tagged/rust.md), [compression](../tagged/compression.md), [zip](../tagged/zip.md)
* :octocat: **[source code](https://github.com/mvdnes/zip-rs)**
---
...
A binary encoder/decoder in Rust [<img src="https://api.travis-ci.org/TyOverby/bincode.svg?branch=master">](https://travis-ci.org/TyOverby/bincode)
* **tags**: [rust](../tagged/rust.md), [encoding](../tagged/encoding.md)
...
A fast and flexible CSV reader and writer, with support for Serde [<img src="https://api.travis-ci.org/BurntSushi/rust-csv.svg?branch=master">](https://travis-ci.org/BurntSushi/rust-csv)
* **tags**: [rust](../tagged/rust.md), [encoding](../tagged/encoding.md)
...
JSON support for [Serde](https://github.com/serde-rs/serde) framework [<img src="https://api.travis-ci.org/serde-rs/json.svg?branch=master">](https://travis-ci.org/serde-rs/json)
* **tags**: [rust](../tagged/rust.md), [encoding](../tagged/encoding.md)
...
[<img src="https://api.travis-ci.org/danburkert/prost.svg?branch=master">](https://travis-ci.org/danburkert/prost)
* **tags**: [rust](../tagged/rust.md), [encoding](../tagged/encoding.md)
...
An XML library in Rust [<img src="https://api.travis-ci.org/shepmaster/sxd-document.svg?branch=master">](https://travis-ci.org/shepmaster/sxd-document)
* **tags**: [rust](../tagged/rust.md), [encoding](../tagged/encoding.md)
...
[<img src="https://api.travis-ci.org/servo/core-foundation-rs.svg?branch=master">](https://travis-ci.org/servo/core-foundation-rs)
* **tags**: [rust](../tagged/rust.md), [gui](../tagged/gui.md)
...
Rust bindings for Nuklear [<img src="https://api.travis-ci.org/snuk182/nuklear-rust.svg?branch=master">](https://travis-ci.org/snuk182/nuklear-rust)
* **tags**: [rust](../tagged/rust.md), [gui](../tagged/gui.md)
...
QML bindings. [<img src="https://api.travis-ci.org/White-Oak/qml-rust.svg?branch=master">](https://travis-ci.org/White-Oak/qml-rust)
* **tags**: [rust](../tagged/rust.md), [gui](../tagged/gui.md)
...
_<sup>https://github.com/libpnet/libpnet</sup>_

A cross-platform, low level networking [<img src="https://api.travis-ci.org/libpnet/libpnet.svg?branch=master">](https://travis-ci.org/libpnet/libpnet)
* **tags**: [rust](../tagged/rust.md), [network-programming](../tagged/network-programming.md)
* :octocat: **[source code](https://github.com/libpnet/libpnet)**
---
#### [tokio-rs/tokio](https://github.com/tokio-rs/tokio)
_<sup>https://github.com/tokio-rs/tokio</sup>_
...
---
#### [dylanmckay/protocol](https://github.com/dylanmckay/protocol)
_<sup>https://github.com/dylanmckay/protocol</sup>_

Custom TCP/UDP protocol definitions
* **tags**: [rust](../tagged/rust.md), [network-programming](../tagged/network-programming.md)
* :octocat: **[source code](https://github.com/dylanmckay/protocol)**
---
#### [actix/actix](https://github.com/actix/actix)
_<sup>https://github.com/actix/actix</sup>_

Actor library for Rust [<img src="https://api.travis-ci.org/actix/actix.svg?branch=master">](https://travis-ci.org/actix/actix)
* **tags**: [rust](../tagged/rust.md), [network-programming](../tagged/network-programming.md)
* :octocat: **[source code](https://github.com/actix/actix)**
---
...
A [Constrained Application Protocol(CoAP)](https://tools.ietf.org/html/rfc7252) library for Rust. [<img src="https://api.travis-ci.org/Covertness/coap-rs.svg?branch=master">](https://travis-ci.org/Cov...
* **tags**: [rust](../tagged/rust.md), [network-programming](../tagged/network-programming.md), [coap](../tagged/coap.md)
* :octocat: **[source code](https://github.com/Covertness/coap-rs)**
---
...
an HTTP implementation [<img src="https://api.travis-ci.org/hyperium/hyper.svg?branch=master">](https://travis-ci.org/hyperium/hyper)
* **tags**: [rust](../tagged/rust.md), [web-programming](../tagged/web-programming.md)
...
A REST-like API micro-framework inspired by [Grape](https://github.com/ruby-grape/grape) and [Hyper](https://github.com/hyperium/hyper) [<img src="https://api.travis-ci.org/rustless/rustless.svg?branc...
* **tags**: [rust](../tagged/rust.md), [web-programming](../tagged/web-programming.md)
...
_<sup>https://speakerdeck.com/jvns/learning-systems-programming-with-rust</sup>_
...
_<sup>https://www.youtube.com/watch?v=t4CyEKb-ywA</sup>_

Presented by [Michael Gattozzi](https://github.com/mgattozzi) @ RustConf 2017
* **tags**: [rust](../tagged/rust.md)
---
#### [Rust: Hack Without Fear!](https://www.youtube.com/watch?v=lO1z-7cuRYI)
_<sup>https://www.youtube.com/watch?v=lO1z-7cuRYI</sup>_

Presented by [Nicholas Matsakis](https://github.com/nikomatsakis) @ C++Now 2018
* **tags**: [rust](../tagged/rust.md)
---
#### [Programming Community Curated Resources for Learning Rust](https://hackr.io/tutorials/learn-rust)
_<sup>https://hackr.io/tutorials/learn-rust</sup>_

A list of recommended resources voted by the programming community.
* **tags**: [rust](../tagged/rust.md)
---
#### [exercism.io](https://exercism.io/tracks/rust)
_<sup>https://exercism.io/tracks/rust</sup>_

programming exercises that help you learn new concepts in Rust.
* **tags**: [rust](../tagged/rust.md)
---
#### [Idiomatic Rust](https://github.com/mre/idiomatic-rust)
_<sup>https://github.com/mre/idiomatic-rust</sup>_

A peer-reviewed collection of articles/talks/repos which teach idiomatic Rust.
* **tags**: [rust](../tagged/rust.md)
* :octocat: **[source code](https://github.com/mre/idiomatic-rust)**
---
#### [Learning Rust With Entirely Too Many Linked Lists](http://cglab.ca/~abeinges/blah/too-many-lists/book/)
_<sup>http://cglab.ca/~abeinges/blah/too-many-lists/book/</sup>_
...
_<sup>https://doc.rust-lang.org/rust-by-example/</sup>_

A description
* **tags**: [rust](../tagged/rust.md)
---
#### [Rust Cookbook](https://rust-lang-nursery.github.io/rust-cookbook/)
_<sup>https://rust-lang-nursery.github.io/rust-cookbook/</sup>_
...
_<sup>https://www.manning.com/livevideo/rust-in-motion?a_aid=cnichols&a_bid=6a993c2e</sup>_

A video series by [Carol Nichols](https://github.com/carols10cents) and [Jake Goulding](https://github.com/shepmaster) (paid)
* **tags**: [rust](../tagged/rust.md)
---
#### [rust-learning](https://github.com/ctjhoa/rust-learning)
_<sup>https://github.com/ctjhoa/rust-learning</sup>_

A collection of useful resources to learn Rust
* **tags**: [rust](../tagged/rust.md)
* :octocat: **[source code](https://github.com/ctjhoa/rust-learning)**
---
#### [Rustlings](https://github.com/rust-lang/rustlings)
_<sup>https://github.com/rust-lang/rustlings</sup>_

small exercises to get you used to reading and writing Rust code
* **tags**: [rust](../tagged/rust.md)
* :octocat: **[source code](https://github.com/rust-lang/rustlings)**
---
#### [stdx](https://github.com/brson/stdx)
_<sup>https://github.com/brson/stdx</sup>_

Learn these crates first as an extension to std
* **tags**: [rust](../tagged/rust.md)
* :octocat: **[source code](https://github.com/brson/stdx)**
---
#### [University of Pennsylvania's Comp Sci Rust Programming Course](http://cis198-2016s.github.io/schedule/)
_<sup>http://cis198-2016s.github.io/schedule/</sup>_

CIS 198: Rust Programming - course website
* **tags**: [rust](../tagged/rust.md)
---
#### [Build a language VM](https://blog.subnetzero.io/post/building-language-vm-part-00/)
_<sup>https://blog.subnetzero.io/post/building-language-vm-part-00/</sup>_
...
_<sup>http://confreaks.tv/events/rustcamp2015</sup>_

Confreaks TV
* **tags**: [rust](../tagged/rust.md)
---
#### [Rust Design Patterns](https://github.com/rust-unofficial/patterns)
_<sup>https://github.com/rust-unofficial/patterns</sup>_

A catalogue of Rust design patterns. Contribute to rust-unofficial/patterns development by creating an account on GitHub.
* **tags**: [rust](../tagged/rust.md)
* :octocat: **[source code](https://github.com/rust-unofficial/patterns)**
---
#### [Rust Guidelines](http://aturon.github.io/)
_<sup>http://aturon.github.io/</sup>_

turon’s web site
* **tags**: [rust](../tagged/rust.md)
---
#### [RustBooks](https://github.com/sger/RustBooks)
_<sup>https://github.com/sger/RustBooks</sup>_

list of RustBooks
* **tags**: [rust](../tagged/rust.md)
* :octocat: **[source code](https://github.com/sger/RustBooks)**
---
#### [Rust Subreddit](https://www.reddit.com/r/rust/)
_<sup>https://www.reddit.com/r/rust/</sup>_
